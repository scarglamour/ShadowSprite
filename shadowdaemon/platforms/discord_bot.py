...
from shadowdaemon.platforms.bot_helper import format_for_discord
from shadowdaemon.utils.error_handler import report_discord_error

# --- Configure intents (no message content needed for slash commands) ---
intents = discord.Intents.default()
intents.guilds = True

class ShadowDaemonBot(commands.Bot):
    def __init__(self):
